...
Hack Reactor operates an immersive Javascript coding school, where we use our proprietary curriculum to help train stellar engineers. A previous student of our program last year, [private] (handle: mmcstpm) has willfully posted our entire curriculum across a series of repositories on github. We've requested that they take down their material but have received no response.

**What files should be taken down? Please provide URLs for each file, or if the entire repository, the repository’s URL.**

https://github.com/mmcstpm/NoSQL-MongoDb  
https://github.com/mmcstpm/SQLDb  
https://github.com/mmcstpm/BART  
