...
https://github.com/abhinav-vir/tradefinance-gcp-marketplace/blob/master/README.md  
The above URL refers to an internal project-related activity.

And also, the Repo was created by an employee of Virtusa who has left the organization a few months back, so he can not delete the repo.

**What files should be taken down? Please provide URLs for each file, or if the entire repository, the repository’s URL.**

https://github.com/abhinav-vir/tradefinance-gcp-marketplace/

**Have you searched for any forks of the allegedly infringing files or repositories? Each fork is a distinct repository and must be identified separately if you believe it is infringing and wish to have it taken down.**

The reported repository URL contains the entirety of the export packages of their website. The fork also leads to the entire repository.
...
We have the owner's email ID, but that is inactive as he left the organization [private].
