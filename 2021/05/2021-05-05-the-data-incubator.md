...
Our Jupyter notebooks have a copyright statement at the very end. You can see it here, for example: https://github.com/Sidharth-123/ds/blob/master/Module%201/python/miniprojects/vc.ipynb
...
The entire repo:  
https://github.com/Segunol/WQU-1  
https://github.com/Sidharth-123/ds

**Have you searched for any forks of the allegedly infringing files or repositories? Each fork is a distinct repository and must be identified separately if you believe it is infringing and wish to have it taken down.**

There should not be forks, as far that I have seen
