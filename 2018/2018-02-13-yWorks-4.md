...
As it seems the github user https://github.com/Raizelb/ has uploaded or allowed to upload one such evaluation version into a public repository at github and we are requesting to remove those files.  

**What files should be taken down? Please provide URLs for each file, or if the entire repository, the repository's URL:**  
https://github.com/Raizelb/Scenario-Group-U/tree/master/circuit/src/lib  
https://github.com/Raizelb/Scenario-Group-U/tree/master/circuit/src/com.yworks.yfiles.javafx.developmentlicense.xml  
