...
In this infringing repository is statement declaring Sensetime’s license in document “license.lic” (URL: https://github.com/AOSiP-Devices/vendor_oneplus/blob/bc6067e84b863fb4d9ec2a15d4a9abe2d7b4d81b/msm8998-common/proprietary/etc/camera/license.lic).

These non-open source documents, of which Sensetime possesses the copyright, are posted by user “AOSiP-Devices” in the repository “vendor_oneplus ” (URL: https://github.com/AOSiP-Devices/vendor_oneplus) without Sensetime’s permission. We confirm that the document below is infringing on our copyright. Please remove the document below and all previous versions in 321 commits under the repository so as to prevent potential infringements in the future.

3. **What files should be taken down? Please provide URLs for each file, or if the entire repository, the repository's URL:

https://github.com/AOSiP-Devices/vendor_oneplus/blob/bc6067e84b863fb4d9ec2a15d4a9abe2d7b4d81b/msm8998-common/proprietary/etc/camera/license.lic  
...
We don't have any contact information about this “AOSiP-Devices” yet, and we would be appreciated if you could help us in doing so.
