...
We are manufacturer and owner of all IP that correspondes to the product yFiles for HTML - https://www.yworks.com/products/yfiles-for-html.  
...
As it seems the github user https://github.com/JorPL/ has uploaded or allowed to upload one such evaluation version into a public repository at github and we are requesting to remove those files.  

**What files should be taken down? Please provide URLs for each file, or if the entire repository, the repository's URL:**  
https://github.com/JorPL/Projet/tree/master/views/lib
