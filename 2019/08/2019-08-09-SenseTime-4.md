...
SenseTime owns a registered copyright named “SenseTime Mobile Face Unlock SDK Software - Android Version V1.0”in China, and the copyright registration number is 2017SR317904. SenseTime's Proprietary and confidential information has been released by a third party (Github user name: RevengeOS-Devices) without authorization and put into the repository: https://github.com/RevengeOS-Devices/vendor_xiaomi_sdm845. However, the information is not open source, any third party has no right to the information.

**What files should be taken down? Please provide URLs for each file, or if the entire repository, the repository’s URL:**   
https://github.com/RevengeOS-Devices/vendor_xiaomi_sdm845
...
We don't have any contact information about this “RevengeOS-Devices” yet, and we hope you can provide to us if you do.
