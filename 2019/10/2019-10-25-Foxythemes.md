Our product Beagle (Web template) was copied onto a GitHub repository without permission. The original product, to which we own the exclusive copyrights, can be found at:
