...
* https://github.com/marionumza/temp10
...
Removing the whole repository is the only solution as it is a full copy of the copyrighted code. Making the repository private is not enough as the code can not be distributed (even privately) without permission.
