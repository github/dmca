...
SenseTime owns a registered copyright named “SenseTime Interactive Living Body Detection SDK Software V1.6”in China, and the copyright registration number is 2018SR113626. SenseTime's Proprietary and confidential information has been released by a third party (Github user name: sxaklje) without authorization and put into the repository:   https://github.com/sxaklje/wheretoborrow. However, the information is not open source, any third party has no right to the information.

**What files should be taken down? Please provide URLs for each file, or if the entire repository, the repository's URL**

https://github.com/sxaklje/wheretoborrow
...
We don't have any contact information about this “sxaklje” yet, and we hope you can provide to us if you do.
