...
is posted online.*  
The code is a close to complete ripoff from one of my
paid modules available here: https://www.gmodstore.com/scripts/view/1112

*What files should be taken down? Please provide URLs for each file, or if
the entire repository, the repository's URL:*  
https://github.com/EzGunzBlazzinn/AHUD - The repository in question is a complete copy of my
work with only minor modifications. All the files in the AHUD/AHud/lua/ are
my work and must be removed.
