...
As it seems the github user https://github.com/pascalalich has uploaded one such evaluation version into a public repository at github and we are requesting to remove those files.

**What files should be taken down? Please provide URLs for each file, or if the entire repository, the repository's URL:**  
https://github.com/pascalalich/swt-swing-demo/blob/master/com.yworks.eclipse.sample3/lib/y.jar
