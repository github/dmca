...
enum kernel_offset {
    ...
    KSTRUCT_OFFSET_PROC_P_FLAG,
    KSTRUCT_OFFSET_PROC_TEXTVP,
    ...
    KSTRUCT_OFFSET_FILEGLOB_FG_OPS,
    ...
    KSTRUCT_OFFSET_VNODE_V_NCCHILDREN_TQH_FIRST,
    KSTRUCT_OFFSET_VNODE_V_MNTVNODES_TQE_NEXT,
    ...
    KSTRUCT_OFFSET_MOUNT_MNT_VNODELIST_TQH_FIRST,
    ...
    /* struct ubc_info */
    KSTRUCT_OFFSET_UBC_INFO_CSBLOBS,
    
    /* struct vm_map */
    KSTRUCT_OFFSET_VM_MAP_FLAGS,
    
    /* struct pmap_cs_code_directory */
    KSTRUCT_OFFSET_PMAP_CS_CODE_DIRECTORY_TRUST_LEVEL,
    KSTRUCT_OFFSET_PMAP_CS_CODE_DIRECTORY_REGISTERED,
    
    /* struct namecache */
    KSTRUCT_OFFSET_NAMECACHE_NC_VP,
    KSTRUCT_OFFSET_NAMECACHE_NC_CHILD_TQE_NEXT,
	...
	KVTABLE_OFFSET_GET_EXTERNAL_TRAP_FOR_INDEX,
