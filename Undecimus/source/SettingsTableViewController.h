...
@property (nonatomic) NSMutableArray *exploits;
...
@property (nonatomic) NSMutableArray *substitutors;
...
@property (weak, nonatomic) IBOutlet UISwitch *readOnlyRootFSSwitch;
...
@property (weak, nonatomic) IBOutlet UILabel *readOnlyRootFSLabel;
...
@property (weak, nonatomic) IBOutlet UIButton *readOnlyRootFSButton;
