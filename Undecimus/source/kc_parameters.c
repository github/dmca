...
static void
init__addresses_12_0()
{
    ADDRESS(paciza_pointer__l2tp_domain_module_start) = kernel_offset(paciza_pointer__l2tp_domain_module_start);
    ADDRESS(paciza_pointer__l2tp_domain_module_stop) = kernel_offset(paciza_pointer__l2tp_domain_module_stop);
    ADDRESS(l2tp_domain_inited) = kernel_offset(l2tp_domain_inited);
    ADDRESS(sysctl__net_ppp_l2tp) = kernel_offset(sysctl__net_ppp_l2tp);
    ADDRESS(sysctl_unregister_oid) = kernel_offset(sysctl_unregister_oid);
    ADDRESS(mov_x0_x4__br_x5) = kernel_offset(mov_x0_x4__br_x5);
    ADDRESS(mov_x9_x0__br_x1) = kernel_offset(mov_x9_x0__br_x1);
    ADDRESS(mov_x10_x3__br_x6) = kernel_offset(mov_x10_x3__br_x6);
    ADDRESS(kernel_forge_pacia_gadget) = kernel_offset(kernel_forge_pacia_gadget);
    ADDRESS(kernel_forge_pacda_gadget) = kernel_offset(kernel_forge_pacda_gadget);
    ...
    ADDRESS(IOUserClient__vtable) = kernel_offset(IOUserClient__vtable);
    ADDRESS(IORegistryEntry__getRegistryEntryID) = kernel_offset(IORegistryEntry__getRegistryEntryID);
}
