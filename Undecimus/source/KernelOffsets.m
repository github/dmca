...
uint32_t kernel_offsets_11_0[] = {
    ...
    0x148, /* KSTRUCT_OFFSET_PROC_P_FLAG */
    0x248, /* KSTRUCT_OFFSET_PROC_TEXTVP */
    ...
    0x28, /* KSTRUCT_OFFSET_FILEGLOB_FG_OPS */
    ...
    0x30, /* KSTRUCT_OFFSET_VNODE_V_NCCHILDREN_TQH_FIRST */
    0x20, /* KSTRUCT_OFFSET_VNODE_V_MNTVNODES_TQE_NEXT */
    ...
    0x40, /* KSTRUCT_OFFSET_MOUNT_MNT_VNODELIST_TQH_FIRST */
    ...
    0x50, /* KSTRUCT_OFFSET_UBC_INFO_CSBLOBS */
    
    0x10c, /* KSTRUCT_OFFSET_VM_MAP_FLAGS */
    
    0x0, /* KSTRUCT_OFFSET_PMAP_CS_CODE_DIRECTORY_TRUST_LEVEL */
    0x0, /* KSTRUCT_OFFSET_PMAP_CS_CODE_DIRECTORY_REGISTERED */
    
    0x48, /* KSTRUCT_OFFSET_NAMECACHE_NC_VP */
    0x10, /* KSTRUCT_OFFSET_NAMECACHE_NC_CHILD_TQE_NEXT */
	...
	0xb7, // KVTABLE_OFFSET_GET_EXTERNAL_TRAP_FOR_INDEX,
...
uint32_t kernel_offsets_12_0[] = {
    ...
    0x13c, /* KSTRUCT_OFFSET_PROC_P_FLAG */
    0x230, /* KSTRUCT_OFFSET_PROC_TEXTVP */
...
#if __arm64e__
    0x54, /* KSTRUCT_OFFSET_PMAP_CS_CODE_DIRECTORY_TRUST_LEVEL */
    0x58, /* KSTRUCT_OFFSET_PMAP_CS_CODE_DIRECTORY_REGISTERED */
#else
    0x0, /* KSTRUCT_OFFSET_PMAP_CS_CODE_DIRECTORY_TRUST_LEVEL */
    0x0, /* KSTRUCT_OFFSET_PMAP_CS_CODE_DIRECTORY_REGISTERED */
#endif
...
uint32_t kernel_offsets_13_0[] = {
...
#endif
#if __arm64e__
    0x3d0, /* KSTRUCT_OFFSET_TASK_ALL_IMAGE_INFO_ADDR */
#else
    0x3d0 - 0x8, /* KSTRUCT_OFFSET_TASK_ALL_IMAGE_INFO_ADDR */
#endif
#if __arm64e__
    0x3d8, /* KSTRUCT_OFFSET_TASK_ALL_IMAGE_INFO_SIZE */
#else
    0x3d8 - 0x8, /* KSTRUCT_OFFSET_TASK_ALL_IMAGE_INFO_SIZE */
#endif
#if __arm64e__
    0x3d8, /* KSTRUCT_OFFSET_TASK_TFLAGS */
#else
    0x3d8 - 0x8, /* KSTRUCT_OFFSET_TASK_TFLAGS */
#endif
    0x0, /* KSTRUCT_OFFSET_TASK_LOCK */
    ...
    0x100, /* KSTRUCT_OFFSET_PROC_UCRED */
    0x0, /* KSTRUCT_OFFSET_PROC_P_LIST */
    0x298, /* KSTRUCT_OFFSET_PROC_P_CSFLAGS */
    0x3f8, /* KSTRUCT_OFFSET_PROC_P_MEMSTAT_STATE */
    0x50, /* KSTRUCT_OFFSET_PROC_MLOCK */
    0xe8, /* KSTRUCT_OFFSET_PROC_UCRED_MLOCK */
    0x32, /* KSTRUCT_OFFSET_PROC_SVUID */
    0x36, /* KSTRUCT_OFFSET_PROC_SVGID */
    0x144, /* KSTRUCT_OFFSET_PROC_P_FLAG */
    0x238, /* KSTRUCT_OFFSET_PROC_TEXTVP */
...
uint32_t koffset(enum kernel_offset offset)
{
    ...
    dispatch_once(&onceToken, ^{
		...
		if (kCFCoreFoundationVersionNumber >= kCFCoreFoundationVersionNumber_iOS_13_0) {
			LOG("offsets selected for iOS 13.0 or above");
			offsets = kernel_offsets_13_0;
