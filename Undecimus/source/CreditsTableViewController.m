...
-(void) darkModeCreditsView:(NSNotification *) notification  {
    init_function();
    [self.appleButton setTitleColor:[UIColor whiteColor] forState:normal];
    ...
    [self.nedButton setTitleColor:[UIColor whiteColor] forState:normal];
...
-(void) lightModeCreditsView:(NSNotification *) notification  {
    init_function();
    [self.appleButton setTitleColor:[UIColor blackColor] forState:normal];
    ...
    [self.nedButton setTitleColor:[UIColor blackColor] forState:normal];
...
-(IBAction)tappedOnApple:(id)sender{
    init_function();
    [[UIApplication sharedApplication] openURL:[CreditsTableViewController getURLForUserName:@"Apple"] options:@{} completionHandler:nil];
}
...
-(IBAction)tappedOnExternalist:(id)sender{
    init_function();
    [[UIApplication sharedApplication] openURL:[CreditsTableViewController getURLForUserName:@"ZecOps"] options:@{} completionHandler:nil];
}
...
- (IBAction)tappedOnNed:(id)sender {
    init_function();
    [[UIApplication sharedApplication] openURL:[CreditsTableViewController getURLForUserName:@"NedWilliamson"] options:@{} completionHandler:nil];
}
