...
Content was copied from ADP internal bitbucket server that References artifacts both ADP internal Artifactory and Bitbucket servers.

https://github.com/cavieres/a2wf

**What files should be taken down? Please provide URLs for each file, or if the entire repository, the repository’s URL.**

Please Remove the Entire Repository - https://github.com/cavieres/a2wf
