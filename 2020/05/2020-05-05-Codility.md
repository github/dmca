...
Text starting from  
"Using React 16 created a "todo list" Requirements: Users"  
to  
"the status message ("X remaining out of Y tasks) element"  

**What files should be taken down? Please provide URLs for each file, or if the entire repository, the repository’s URL.**

https://github.com/gustavexx/todo-list-component/blob/master/README.md
