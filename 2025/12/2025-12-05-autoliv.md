...
The offending account is https://github.com/marius-stan764

There are 3 public repositories listed:  
https://github.com/marius-stan764/daimler_handwheel_ecu  
https://github.com/marius-stan764/audi_handwheel_ecu  
https://github.com/marius-stan764/geely_handwheel_ecu

ADDITIONAL INFO: We had also opened 3 tickets a few weeks ago related to the SAME content posted (Ticket # are: 3856727, 3856933, 3859118). The outcome in those cases was the DMCA takedown of 7 repositories (original + forks). It seems this user has posted the SAME content again.
...
The code is saved into an [private] [private] in a product called [private]. We have access restricted to the developers who are involved. But we cannot prevent them from downloading if they need to work on it.
...
No...at the moment we dont know. Previous leak had occured under the account of [private]. Present leak is with the name of marius-stan764. But both have the same followers. So it could be a renamed user? But we are not sure
