...
We have found material on your service that promotes, directs to, or enables the ongoing infringement via Hayase. The infringing material comprises the above-mentioned Protected Work(s). Please find the GitHub Channel(s) where similar infringing material can be accessed below:

GitHub Channel(s):

https://github.com/hayase-app
...
https://github.com/hayase-app/docs/releases/download/v6.4.36/android-6.4.12.apk

https://github.com/hayase-app/docs/releases/download/v6.4.36/latest-linux.yml

https://github.com/hayase-app/docs/releases/download/v6.4.36/latest-mac.yml

https://github.com/hayase-app/docs/releases/download/v6.4.36/latest.yml

https://github.com/hayase-app/docs/releases/download/v6.4.36/linux-hayase-6.4.36-linux.AppImage

https://github.com/hayase-app/docs/releases/download/v6.4.36/linux-hayase-6.4.36-linux.deb

https://github.com/hayase-app/docs/releases/download/v6.4.36/mac-hayase-6.4.36-mac.dmg

https://github.com/hayase-app/docs/releases/download/v6.4.36/mac-hayase-6.4.36-mac.dmg.blockmap

https://github.com/hayase-app/docs/releases/download/v6.4.36/mac-hayase-6.4.36-mac.zip

https://github.com/hayase-app/docs/releases/download/v6.4.36/mac-hayase-6.4.36-mac.zip.blockmap

https://github.com/hayase-app/docs/releases/download/v6.4.36/win-hayase-6.4.36-installer.exe

https://github.com/hayase-app/docs/releases/download/v6.4.36/win-hayase-6.4.36-installer.exe.blockmap

https://github.com/hayase-app/docs/archive/refs/tags/v6.4.36.zip

https://github.com/hayase-app/docs/archive/refs/tags/v6.4.36.tar.gz

https://github.com/hayase-app/docs/releases/download/v6.4.35/android-6.4.12.apk

https://github.com/hayase-app/docs/releases/download/v6.4.35/latest-linux.yml

https://github.com/hayase-app/docs/releases/download/v6.4.35/latest.yml

https://github.com/hayase-app/docs/releases/download/v6.4.35/linux-hayase-6.4.35-linux.AppImage

https://github.com/hayase-app/docs/releases/download/v6.4.35/linux-hayase-6.4.35-linux.deb

https://github.com/hayase-app/docs/releases/download/v6.4.35/win-hayase-6.4.35-installer.exe

https://github.com/hayase-app/docs/releases/download/v6.4.35/win-hayase-6.4.35-installer.exe.blockmap

https://github.com/hayase-app/docs/archive/refs/tags/v6.4.35.zip

https://github.com/hayase-app/docs/archive/refs/tags/v6.4.35.tar.gz
