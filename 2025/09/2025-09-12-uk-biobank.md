...
UK Biobank owns all intellectual property rights over data that has been posted within the forked repository: https://github.com/suyanzhou626/BNN-for-Uncertainty-Estimation-of-Imaging-Biomarkers. The data is licensed by UK Biobank to bona-fide researchers to conduct research in association with their approved purpose only and in accordance with contractual terms agreed between the parties. Such licence does not extend to the ability to post the data on a public forum. The original repository from which the infringing material was forked has been removed but we are unable to identify or contact the owner of this forked repository for the infringing material to be removed.

 

We request that the forked repository https://github.com/suyanzhou626/BNN-for-Uncertainty-Estimation-of-Imaging-Biomarkers is removed immediately in accordance with the DMCA requirements.
