...
UK Biobank owns all intellectual property rights over data that has been posted to the following repositories:  
  
   
  
https://github.com/yochaiedlitz/T2DM_UKB_predictions  
  
https://github.com/Farida-Ali/T2DM_UKB_predictions  
  
   
  
The data is licensed by UK Biobank to bona-fide researchers to conduct research in association with their approved purpose only and in accordance with contractual terms agreed between the parties. Such licence does not extend to the ability to post the data on a public forum. We have attempted to contact the owner of this repository without success.  
  
   
  
We request that the repositories are removed immediately in accordance with the DMCA requirements.  
