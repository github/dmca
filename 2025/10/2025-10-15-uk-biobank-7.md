...
We have identified the following URLs which contains the specific files in the repository that infringes upon our copyright and we request that this file is removed immediately in accordance with the DMCA requirements:

 

https://github.com/alatteaday/data2vec_bert_ukb/blob/main/data/pre_train.csv

https://github.com/alatteaday/data2vec_bert_ukb/blob/main/data/pre_val.csv
