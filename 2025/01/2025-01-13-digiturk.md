...
We are writing to you from Digiturk (BeIN Media Group), which is the largest PAY TV in [private] and holds the rights to broadcast Super League Football Matches and 90-minute live matches with paid subscriptions to our subscribers.  
...
Data taken from github sample image  
[private]  

**What files should be taken down? Please provide URLs for each file, or if the entire repository, the repository’s URL.**

account from which illegal codes were withdrawn  
https://github.com/trxtron/
...
https://github.com/trxtron/sha256key/blob/main/trxkey
