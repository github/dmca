...
It appears that the same user who previously violated the copyright of our game Eggy Car on your platform ([private]) has reuploaded the content under a new subpath:

https://eggy-car.github.io/eggy-car/

This clearly demonstrates an intent to circumvent the previous takedown and continue hosting the same infringing material.

Given this behavior, we believe it constitutes a deliberate abuse of your platform.
...
https://github.com/eggycars/eggycars.github.io
...
We respectfully request that the associated user account be reviewed and suspended to prevent further violations.
