...
We have identified the following files in the following repositories that infringe upon our copyright:

 

https://github.com/gerstung-lab/uk_biobank_survival/blob/main/scripts/00_ukb_to_hdf5.py

https://github.com/gerstung-lab/uk_biobank_survival/blob/77c5883b70551ea480dfcc291d3fd412f7e23dd8/scripts/.ipynb_checkpoints/00_ukb_to_hdf5-checkpoint.py

https://github.com/rrrrrs1/uk_biobank_survival/blob/main/scripts/00_ukb_to_hdf5.py

https://github.com/rrrrrs1/uk_biobank_survival/blob/77c5883b70551ea480dfcc291d3fd412f7e23dd8/scripts/.ipynb_checkpoints/00_ukb_to_hdf5-checkpoint.py

 

The data is licensed by UK Biobank to bona-fide researchers to conduct research in association with their approved purpose only and in accordance with contractual terms agreed between the parties. Such licence does not extend to the ability to post the data on a public forum. We have attempted to contact the owner of the repositories for the infringing material to be removed but without success and we request that these files are removed immediately in accordance with the DMCA requirements
