...
https://github.com/PersonomicsLab/popmodel_ML_MH/blob/81fdab51cb8c1928318d69aab13b48fc423728b3/manipulations/phenotype_averaging/WAPIAW2_Clean.ipynb

 

The data contained in this file is licensed by UK Biobank to bona-fide researchers to conduct research in association with their approved purpose only and in accordance with contractual terms agreed between the parties. Such licence does not extend to the ability to post the data on a public forum. We have attempted to contact the repository owner but without success, and therefore we request that this file is removed immediately in accordance with the DMCA requirements.
