...
https://github.com/Fmerella/Proteomics_UKBB-/blob/7d856888cb5ef83c41f7b9ecbe8e380ff6b3eb10/Compute_NA%20with_lowest_value_%26_proteomic_expression.R

 

The data contained in this file is licensed by UK Biobank to bona-fide researchers to conduct research in association with their approved purpose only and in accordance with contractual terms agreed between the parties. Such licence does not extend to the ability to post the data on a public forum. We are unable to contact or identify the repository owner and we therefore request that this file is removed immediately in accordance with the DMCA requirements.
