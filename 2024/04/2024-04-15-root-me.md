...
As we do not consider publishing solution as a student work or a simple mention. We found out that the Github user 'KageSiNo' have leaked Root-Me owned exercise:

https://github.com/KageSiNo/Root-me-Web-Server

For example, you can find [private] here: https://github.com/KageSiNo/Root-me-Web-Server/blob/main/Backup%20File/README.md .
Another example is [private] where the leak is available here https://github.com/KageSiNo/Root-me-Web-Server/blob/main/File%20upload%20-%20Null%20byte/README.md .
If you take a look at the repository, you will understand that the entire repository 'Root-me-Web-Server' without exception contains Root-Me foundation properties that need to be deleted or at least made private.
