...
1) Link: https://github.com/doguyildizhannn/NumberOfRecs?tab=readme-ov-file#numberofrecs  
Text starting from: "There is a matrix A of integers, consisting of R rows"  
to: "matrix A is an integer within the range [-1,000,000,000..1,000,000,000]."  
