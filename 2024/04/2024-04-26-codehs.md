...
I am an employee of CodeHS, Inc.
...
Although they may appear to be the student's own work, they are merely the solutions to proprietary assignments and assessments which are curricular material created by CodeHS for which we own the copyright. When you compare program names to course activity names here: [https://codehs.com/course/6165/explore/module/8790/lesson/1656420] each title in the repository is from part of the CodeHS AP CSA Java course. Additionally, the first sentence in the repository's description states "This repo contains all my solutions for CodeHS's AP CSA course."

**What files should be taken down? Please provide URLs for each file, or if the entire repository, the repository’s URL.**

https://github.com/homris/CodeHS-CSA-Solutions
