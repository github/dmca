...
As we do not consider publishing solution as a student work or a simple mention. We found out that the Github user 'ablessin' have leaked Root-Me owned exercise:

https://github.com/ablessin/RootMe

For example, you can find [private] here: https://github.com/ablessin/RootMe/blob/main/HTML%20-%20boutons%20d%C3%A9sactiv%C3%A9s .
Another example is [private] where the leak is available here https://github.com/ablessin/RootMe/blob/main/Javascript%20-%20Obfuscation%202 .
If you take a look at the repository, you will understand that the entire repository 'RootMe' without exception contains Root-Me foundation properties that need to be deleted or at least made private.
