...
The program generates an html based report based on one or multiple lssecfix output files. It was created by a former IBM employee (Author: [private] - [private]) for internal use only. See line #140 [private]  

**What files should be taken down? Please provide URLs for each file, or if the entire repository, the repository’s URL.**

https://github.com/halulunyan/shellscript/blob/master/lssecfixes_report.py  
https://github.com/halulunyan/shellscript/blob/master/lssecfixes
...
Name and Title of BSA [private]: [private], [private]  
Address: [private]  
