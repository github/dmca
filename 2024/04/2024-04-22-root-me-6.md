...
As we do not consider publishing solution as a student work or a simple mention. We found out that the Github user 'renauddahou' have leaked Root-Me owned exercise:

https://github.com/renauddahou/rootmee2

For example, you can find [private] here: https://github.com/renauddahou/rootmee2/blob/main/CSRF/CSRFtokenbypass/CSRFtokenbypass.md .
Another example is [private] where the leak is available here https://github.com/renauddahou/rootmee2/blob/main/PHP/PHP-registerglobal/PHP-registerglobal.md .
