...
https://github.com/FrostLua/Krakles/blob/main/ElgatoHub/LibChanger.lua
...
The repository must be removed, and the user should be terminated due to multiple infractions and reuploading content using the same unauthorized Lua obfuscator.
