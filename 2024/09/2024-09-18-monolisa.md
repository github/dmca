...
https://github.com/ltfred/code-font  
https://github.com/ltfred/code-font/blob/master/MonoLisa%20Font.zip
...
You can only download the typeface through the ‘Buy’ page of our own website after payment. Per EULA you are not allowed to distribute the bought typeface to any third party which is what user Itfred is doing.
The MonoLisa typeface is NOT legally available on Github.

**How is the accused project designed to circumvent your technological protection measures?**

User Itfred illegally offers a full version of the typeface for free on Github (see mentioned links).

**<a href="https://docs.github.com/articles/dmca-takedown-policy#b-what-about-forks-or-whats-a-fork">Have you searched for any forks</a> of the allegedly infringing files or repositories? Each fork is a distinct repository and must be identified separately if you believe it is infringing and wish to have it taken down.**

MonoLisa is – unfortunately – available on many repositories. Some maybe connected. But we are reporting each of them separately.
