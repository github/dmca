...
The file "nebula.blueprint" is part of the download of Nebula, which is only provided to customers that have purchased Nebula.

**What files should be taken down? Please provide URLs for each file, or if the entire repository, the repository’s URL.**

https://github.com/VapeQueen/nebula-theme
