...
As we do not consider publishing solution as a student work or a simple mention. We found out that the Github user 'trietptm' have leaked Root-Me owned exercise:

https://gist.github.com/trietptm/6680849

The following program is made to solve one of our challenge: https://www.root-me.org/en/Challenges/Programming/Mathematic-progression
This challenge falls under the properties of the Root-Me Foundation, which means that the content must be removed or at least made private.
...
Yes, the gist was forked one time:

https://gist.github.com/ziednamouchi/538f127680142dfa35cb586c43060e14

As the content is exactly the same, we ask that they be treated in the same way.
