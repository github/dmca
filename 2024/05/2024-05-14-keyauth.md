...
https://github.com/codeinewtf/KeyAuth-Protected-Loader
...
This repository displays the leaked source code of an application that is using our client-side API and states that it is "protected" However, the original post made from the owner of the repository posted on [private], and stated this is "Bypassing Keyauth.win(client-side) loader". The user is simply hiding the fact that it's an actual bypass for the eyes of GitHub. This is a violation of the anti-circumvention clause within the DMCA and I request removal.

While the name of the repository
