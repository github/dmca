...
As we do not consider publishing solution as a student work or a simple mention. We found out that the Github user 'KaitoRyouga' have leaked Root-Me owned exercise:

https://github.com/KaitoRyouga/Rootme-web-server/

For example, you can find [private] here: https://github.com/KaitoRyouga/Rootme/blob/master/HTML%20-%20Source%20code%20(ch1)/README.md .
Another example is [private] where the leak is available here [https://github.com/KaitoRyouga/Rootme/blob/master/HTTP%20-%20Improper%20redirect%20(ch32)/README.md](https://github.com/KaitoRyouga/Rootme/blob/master/https%20-%20Improper%20redirect%20(ch32)/README.md) .
...
The repository have been forked 1 times. We analysed it independently and noticed that it is up to date with the repository we are noticing here. As the content is exactly the same, we ask that it be treated in the same way: https://github.com/WendellTech/Rootme-web-server
