...
the source code [private] (in Python) is unveiling our security code for license activation  
(it is a copy of the [private]. previously closed by DMCA takedown).
...
i don't find any other fork for the moment.
