...
The repositories that we are reporting have posted their solutions to our exercises. Their solutions are mostly exact copies of our starter code, not original work. This fork contains no differences from the one that you all just took down for us (https://github.com/CMU-CS-ACADEMY-CODING/CMU-CS-Academy-Answers)

**What files should be taken down? Please provide URLs for each file, or if the entire repository, the repository’s URL.**

https://github.com/pearham/CMU-CS-Academy-Answers
