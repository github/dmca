...
https://github.com/paultawfik/Maximum-Product-of-Array-Slice-Problem/blob/master/README.md  
from "A non-empty zero-indexed array 'A' consisting of N real numbers is
given."
to "(not counting the storage required for input arguments)"
is taken from task MaxSliceProduct
