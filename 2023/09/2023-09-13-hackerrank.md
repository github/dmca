...
[private]  
The entire repository infringes HackerRankʼs works and is an exact copy of our internal problem ID: [private]. The repository infringes the literary work of a unique problem scenario, coding solutions, and works of visual art authored by HackerRank. Our works include Hackerrankʼs copyright notice and are not open source.

**What files should be taken down? Please provide URLs for each file, or if the entire repository, the repository’s URL.**

https://github.com/amanr11314/Articles-ReactTest-Hackerrank
