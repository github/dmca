...
URL: https://github.com/jaiomkul/meesho-ecom

Meesho has not authorized any third parties to use and abuse the website code as the Meesho website code can be used by their competitors to create a competing site or malicious fraud actors to engineer a phishing site targeting Meesho. Their use of the copyrighted work in this unauthorized manner is infringing and should be removed/taken down immediately.

Please note we are claiming copyright to the entire repository as we have checked and found each file is a copy of the Meesho website's assets and individual pages and full order and cart functionality found on Meesho's website which are copyrighted content Meesho owns.
