...
https://github.com/elidoesexploits/eaglercraftx  
https://github.com/elidoesexploits/FuschiaX  
https://github.com/elidoesexploits/Kerosene-Client

Unsure if it is acceptable to report all of these repo's in one takedown, but as they are all under the same user, and there is only a single fork on one of the repos, wanted to see if submitting this way is acceptable.
...
@sexy-potatoes sexy-potatoes / Kerosene-Client
