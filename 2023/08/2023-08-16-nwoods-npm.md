...
Northwoods Software Corporation (nwoods.com) is the copyright owner of all versions of the GoJS library (gojs.net).  
I am a [private] at Northwoods Software Corporation.
...
https://gojs.net/1.8.36/release/go.js

**What files should be taken down? Please provide URLs for each file, or if the entire repository, the repository’s URL.**

https://www.npmjs.com/package/gojsnomark
...
The software displays a watermark unless a valid license key is provided.

**How is the accused project designed to circumvent your technological protection measures?**

The code was modified not to display the watermark.
