...
My authentication service https://keyauth.cc seen at https://youtube.com/KeyAuth has been circumvented, allowing people to pirate software from my customers. This is very detrimental and I request removal of the repository and any forks if they exist at the time of viewing.

**What files should be taken down? Please provide URLs for each file, or if the entire repository, the repository’s URL.**

https://github.com/6nz/keyauth-python-bypass
