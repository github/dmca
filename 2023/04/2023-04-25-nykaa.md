...
The copyrighted work is the full (or an outdated version) Nykaa website code found at - https://www.nykaa.com/ (the official website of Nykaa)

**What files should be taken down? Please provide URLs for each file, or if the entire repository, the repository’s URL.**

We are claiming copyright for the entire repository URL below and not just specific content.

URL: https://github.com/rushi2784/React-Nykaa-U4
