...
My name is [private], an [private] from iZoologic, a private company and an authorization representative of Paytm.

**Please provide a detailed description of the original copyrighted work that has allegedly been infringed. If possible, include a URL to where it is posted online.**

The copyrighted work was copied from the website of Paytm: https://paytm.com/
...
Account Uploader: https://github.com/Prajakta5245

Infringing Content: https://github.com/Prajakta5245/PaytmWeb

https://github.com/Prajakta5245/PaytmWeb/blob/main/index.html

The Infringing content is the main page of our client Paytm and its contents and structure has been copied unto the repository contents. The content and its user interface are almost the same as the original. Our client Paytm requests to remove the infringing content to prevent any fraudulent activity that could be done by the repository created on your platform of a non-affiliated user.

Original Main page: https://paytm.com/

Please note Paytm has not authorized the user to copy the index page of Paytm as it can be used to analyze vulnerabilities and company secrets and create duplicate or phishing sites aiming for Paytm customers.
