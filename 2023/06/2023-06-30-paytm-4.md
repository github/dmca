...
[https://github.com/123RAGHUVARMA/paytmclone_](https://github.com/123RAGHUVARMA/paytmclone_)

We are requesting to remove the entire repository as it can be used to create phishing sites to target our client and unsuspecting users.
