...
1) Link :   
https://github.com/Fabio-S-Silva2/debounced_autocomplete

Text starting from  
"1. In order to fetch items based"  
to  
"<a class="list-item">Macedonia</a>  
</div>"

Original Content (behind a paywall): https://app.codility.com/task-library/#/autocomplete
