...
Our copyright registration number is TX0007948710 in https://www.copyright.gov

**Please provide a detailed description of the original copyrighted work that has allegedly been infringed. If possible, include a URL to where it is posted online.**

The content that is being infringed is our software for GPT (Get-Paid-To) sites to manage paid-to-click ads, offerwalls, banner ads, text ads, link ads with demo available in:  
https://demo.evolutionscript.com  
https://demo.evolutionscript.com/admin

**What files should be taken down? Please provide URLs for each file, or if the entire repository, the repository’s URL.**

https://github.com/OMEGAYALFA/EvolutionScript  
https://github.com/levanchien1412/EvolutionScript  
https://github.com/chienbigstar/EvolutionScript
...
Yes, GitHub user has uploaded our source code from old version.
