...
I am an enforcement agent for Microsoft. My scope of enforcement is for Minecraft within Mojang AB
...
The repo contains files extracted from Minecraft 1.14.

**What files should be taken down? Please provide URLs for each file, or if the entire repository, the repository’s URL.**

https://github.com/EaglerDevs/EaglerCraft
...
@CatsheeDev CatsheeDev / EaglerCraft    
@DeltaPv DeltaPv / EaglerCraft
...
We do not, only what is available on their repo.
