...
https://apps.odoo.com/apps/modules/14.0/stock_qty_forecast/

**What files should be taken down? Please provide URLs for each file, or if the entire repository, the repository’s URL.**

https://github.com/humanytek/grqz/tree/master/stock_qty_forecast (the whole folder)
...
https://github.com/izzihector/grqz/tree/master/stock_qty_forecast (the whole folder)  
[invalid] (the whole folder)
