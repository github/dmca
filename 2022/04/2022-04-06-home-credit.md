...
Mobile MS APP is our is an internal project in our company ("Home Credit Consumer Finance Co., Ltd"). You can see the UAT code was uploaded to above link. You can even see our company name "homecredit" in the URL and the Mobile MS APP's UAT url ([invalid]).

**What files should be taken down? Please provide URLs for each file, or if the entire repository, the repository’s URL.**

The entire repository https://github.com/underspare/vue3-dashboard/tree/21c336c5335394845fb97f711ebdaa605df135b3
...
No. We only know the Github user name is "shanejix".
