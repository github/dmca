...
This IPTV App (CinemaHD) includes illegal and unauthorized Pay Tv Sky IT tv series:  
Gomorra

**Please provide a detailed description of the original copyrighted work that has allegedly been infringed. If possible, include a URL to where it is posted online.**

The CinemaHD app, an app that allows you to watch movies and TV series totally for free.
...
https://www.sky.it/tv/sky-tv/serie-tv/gomorra  

1- Go to https://github.com/TeruSetephen/cinemaapk/blob/master/release/app-production-release.apk and download APK  
2- App installed  
3- At the top, click on search icon  
4- Search “Gomorra“ and click on Gomorra image  
5- Click on "Season 5"  
6- Click on play button for 5x1 (Episode 1)  
7- Sky content "Gomorra"

**What files should be taken down? Please provide URLs for each file, or if the entire repository, the repository’s URL.**

https://github.com/TeruSetephen/cinemaapk/blob/master/release/app-production-release.apk
