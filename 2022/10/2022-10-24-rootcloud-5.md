...
The name of rootcloud can be clearly seen in line 37-40 of the infringement code. The author's name is [private], the email address is [private], and the company website of rootcloud.com is available. The code project name is [private]. This is exactly the same as our internal code platform.
You can see in our internal document about infringing code images: [private], [private], [private]

**What files should be taken down? Please provide URLs for each file, or if the entire repository, the repository’s URL.**

The whole repository - https://github.com/1053531172/quick_dev
