...
https://github.com/shirobusa1997/DEIML_DiscoveryDome

All of the content in the Assets/Vuplex directory should be taken down:

https://github.com/shirobusa1997/DEIML_DiscoveryDome/tree/cddcd30ad77877abd6d2508636cb4add68e9d653/Assets/Vuplex

I would normally open an issue in the repo to ask the owner to make the repo private, but the repo is archived so I'm unable to do that. I believe the best way to remediate the issue would be to either force the repo to be private or to take it down.
