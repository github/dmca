...
For example, the files in https://github.com/Akebi-Group/Akebi-GC/tree/v0.95/cheat-library/src/appdata are from our game. The repositories copied and reverse-engineered our code to build a private server.
