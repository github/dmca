...
• https://github.com/caigee-cmd/wechat-insight   
   
The Unlawful Repository describes itself as offering tools that, inter alia, “extract[] chat logs from a local encrypted database” (as translated).   
