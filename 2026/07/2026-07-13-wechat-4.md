...
The Unlawful Repository describes itself as offering a tool to “automatically extract WeChat database keys, decrypt and parse local databases” (as translated).   
...
derivative works of data released into any terminal's memory by the Software or during its operation… including but not limited to using plugins, add-ons or third-party tools/services not authorized by Tencent to access the Software and its related systems” (§8.2.1.4);   
