...
IterationRP is a shader package developed based on Minecraft Java Edition, relying on the Iris Shader module. This shader utilizes ray tracing technology, combined with [private]' personal aesthetic, to successfully showcase outstanding visual performance and stunning artistic style. But because the shader is still in the early stages of development, it is not available for free open source release on any platform. Please note that the license file inside this shader package indicates: Copyright (C) 2025 [private]  
...
https://github.com/bkwhite12/IterationRP-Alpha  
