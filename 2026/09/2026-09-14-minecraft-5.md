...
https://github.com/keketwt/powerx-client  
The entire repository is infringing.  
  
1,617 bundled net/minecraft / com/mojang classes — actual decompiled/repackaged Minecraft Java bytecode (not a Forge/Fabric mod that merely references MC via mappings — it contains the game's own classes).  
4,073 copied Minecraft assets (textures / lang / sounds).  
580 distinctive Minecraft string constants (derivation signal).  
