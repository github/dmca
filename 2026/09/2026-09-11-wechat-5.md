...
• https://github.com/ddgsdde/wechat-chat-exporter   
   
The Unlawful Repository describes itself as offering tools to “[e]xport chat history from the decrypted local WeChat database,” including by “[e]xtract[ing] the key” and “[d]ecrypt[ing] the database” (as translated).   
