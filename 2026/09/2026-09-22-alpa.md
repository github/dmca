...
The user “https://github.com/movixcorp” has created the following repo for the sole purpose of sharing a software dedicated to pirating content on the website “movix.chat”. Indeed, as explained on the repo itself, these repos are made to access the extension needed to get content on the aforementioned website massively counterfeiting :

https://github.com/movixcorp/MovixOpenSource

This website has been judged massively counterfeiting by the court of Paris on March 19th, 2026 (Court Order [private] provided in this email).

This is the third repost from this user (see our notice number [private] and [private], please ban this user as well.

Please remove this repo.
