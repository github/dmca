...
We are the copyright owner of the official LCP encryption profiles used by ebook distributors worldwide. More information about our role relative to LCP is found in https://www.edrlab.org/readium-lcp/.
...
https://github.com/bingbangbopper/lcpdedrm
...
- This DRM solution does not hurt the accessibility of the content it protects; this is why it is promoted by the DAISY Consortium.
...
The user has published on GitHub software that specifically allows the decryption of ebooks protected by the LCP Encryption Profiles and allows saving them as non-protected ebooks. This infringement violates our legal business and affects authors and publishers’ IP.
