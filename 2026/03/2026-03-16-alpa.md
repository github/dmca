NOTICE OF COPYRIGHT INFRINGEMENT ref. 37393/2026

 

Sent via email on [private]
...
TWENTIETH CENTURY FOX ENTERTAINMENT FRANCE - RCS [private]

THE WALT DISNEY COMPANY FRANCE - RCS [private]

SONY PICTURES HOME ENTERTAINMENT - RCS [private]

STUDIOCANAL - RCS [private]

GAUMONT - RCS [private]

SOCIETE NOUVELLE DE DISTRIBUTION (SND) - RCS [private]

PARAMOUNT PICTURES FRANCE - RCS [private]

PATHÉ - RCS [private]

TF1 VIDEO - RCS [private]

UGC - RCS [private]

UNIVERSAL PICTURES VIDEO FRANCE - RCS [private]

WARNER BROS. ENTERTAINMENT FRANCE - RCS [private]

Motion Picture Association (MPA) - [private]

La Société des Auteurs, Compositeurs et Editeurs de Musique (SACEM) [private]

La Société des auteurs et compositeurs dramatiques (SACD) - [private]
...
ALPA is also a trusted flagger, as per article 22 of the DSA (2022/2065) and ARCOM’s (France content regulator) deliberation on March 27th, 2025.
...
The user “https://github.com/p-stream” has created the following repos for the sole purpose of sharing a software dedicated to pirating content on the website “[private]”. Indeed, as explained on the repo itself, these repos are made to access the extension needed to get content on the aforementioned website:
...
You can even see the interface and titles right from the main image of the repo.
...
They also link directly to their documentation: [invalid]

“A cutesy app for watching your favorite movies and shows. Totally free and open source, forever!”

 

Please remove these repos and ban the user to avoid it being created again.
