...
The content in question (source code, documentation, etc.) is a company deliverable created in the course of business, and the copyright belongs to Aisin Software Co., Ltd. As an employee of Aisin Software Co., Ltd., I have been involved in [private] and [private] this deliverable, and this is a claim concerning a copyrighted work of Aisin Software Co., Ltd.

**Please provide a detailed description of the original copyrighted work that has allegedly been infringed.**

The original copyrighted work consists of source code and related documentation that are managed as part of Aisin Software Co., Ltd.’s business operations. Specifically, it is the complete set of programs for the project “[private]” (internal project name), including application code, configuration files, and build/execution procedures.    
The originality of the work lies in aspects such as the file structure, implementation (functions, classes, scripts), comments, configuration values, and documentation descriptions.
...
[https://github.com/Marco-Just/sr6g6-demo-pf
