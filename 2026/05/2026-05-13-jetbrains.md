...
https://github.com/Teodoorpenal672/baiqi-GhostReg
...
The repository in question provides an access to a software that tampers with JetBrains official website and designed to register fake accounts in order to resell them without authorization, as well as aggregate them in order to circumvent technical protection limiting the use of individual account to a specific person.
