...
The original work is not publicly available as it was stored in a private [private] [private]. It was intended for private security research and was leaked without authorization.
...
https://github.com/luvettee/girlyboys.net
...
These measures effectively controlled access by ensuring the code was not indexed, not public, and only accessible via [private] verified account credentials. The unauthorized distribution occurred because these access controls were bypassed through a compromise of [private] [private] account security.
...
I do not have the infringer's direct contact information beyond their GitHub profile [private]. The content was uploaded anonymously following an unauthorized access to [private] private data.
