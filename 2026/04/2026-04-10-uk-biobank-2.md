...
We have identified the following file in the repository that infringe UK Biobank’s intellectual property rights:

 

https://github.com/JingnanBai/BIS687-Capstone-group-8/blob/471aabd9ce156c66d8aa00e656b884ad77e5643d/data/ukbiobank.rds

 

These files contains structured unique identifiers and health data in a table originating from the UK Biobank database which has been reproduced without authorization. As mentioned above the UK Biobank database is a proprietary research database, created by UK Biobank through substantial investment. UK Biobank has attempted to contact the repository owner to remove this file but without success.
