...
UK Biobank has identified a repository and a number of forks hosted on GitHub that contains files derived from, or reproducing portions of, the UK Biobank dataset.

 

We have identified the following files within each repository that infringe UK Biobank’s intellectual property rights:

 

https://github.com/Hinna0818/UKBAnalytica/blob/d6facb23a147b51a335223a9bb12141b5cbfd32a/tests/testthat/testdata/raw_demo.csv

https://github.com/blitz305/UKBAnalytica/blob/d6facb23a147b51a335223a9bb12141b5cbfd32a/tests/testthat/testdata/raw_demo.csv

https://github.com/lcx777-afk/UKBAnalytica/blob/d6facb23a147b51a335223a9bb12141b5cbfd32a/tests/testthat/testdata/raw_demo.csv 

 

The identified file contains over a  1000 unique identifiers alongside associated data of attending assessment centre, BMI, date of first diagnosis for ICD10 codes etc which originate from the UK Biobank database and has been reproduced without authorization. As mentioned above the UK Biobank database is a proprietary research database, created by UK Biobank through substantial investment. UK Biobank has been unable to identify or contact the repository owner to request removal of the file.
