...
1) Link: https://github.com/Valliammai-Subramanian/coding-questions-in-sql/blob/main/README.md  
Text starting from: You are given two tables, flights and airports  
Text to:  there are no flights with the same start_port and end_port.  
Original content (behind a paywall): https://app.codility.com/task-library/#/sql_flights  
The README file contains our copyrighted task descriptions.  
