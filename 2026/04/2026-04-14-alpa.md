NOTICE OF COPYRIGHT INFRINGEMENT ref. 37646/2026

 

Originally sent via email on [private]
...
The user “https://github.com/MysticSaba-max” has created the following repo for the sole purpose of sharing a software dedicated to pirating content on the website “movix.rodeo”. Indeed, as explained on the repo itself, these repos are made to access the extension needed to get content on the aforementioned website massively counterfeiting :

 

https://github.com/MysticSaba-max/movix-open-source

 

This is the second repost from this user (see our notice number 37592/2026), please ban this user as well.
