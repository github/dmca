...
[https://www.ukbiobank.ac.uk/learn-more-about-uk-biobank/about-us](https://www.ukbiobank.ac.uk/learn-more-about-uk-biobank/about-us)
...
UK Biobank has identified two forked repositories hosted on GitHub that contains files derived from, or reproducing portions of, the UK Biobank dataset.

We have identified the following files within the repositories that infringe UK Biobank’s intellectual property rights:

https://github.com/Victory-Hugo/mtSwirl/blob/f0b35adf5f99fade385c62b718ed8bad92b1de8d/submission_pipelines/dx/utils/completed_sample_list.txt

https://github.com/jessicaway/mtSwirl/blob/f0b35adf5f99fade385c62b718ed8bad92b1de8d/submission_pipelines/dx/utils/completed_sample_list.txt

These files contains a list of unique identifiers originating from the UK Biobank database which has been reproduced without authorization. As mentioned above the UK Biobank database is a proprietary research database, created by UK Biobank through substantial investment. UK Biobank has attempted to contact the repository owners but without success. We can confirm that we have contacted the original repository owner and other fork owners who have made changes to remove the infringing content.  
