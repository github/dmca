...
The offending account is https://github.com/isavelife

There are 3 public repositories listed:  
https://github.com/isavelife/alv_sandbox-daimler  
https://github.com/isavelife/alv_audi_sandbox  
https://github.com/isavelife/alv_geely_sandbox

ADDITIONAL INFO: We had also opened a total of 4 tickets in the last few weeks ago related to the SAME content posted (Ticket # are: 3941019, 3856727, 3856933, 3859118). The outcome in those cases was the DMCA takedown of 10 repositories (original + forks). It seems this user (renamed a few times) has posted the SAME content the THIRD time.
...
No...at the moment we dont know. Previous leaks occured under the accounts of [private] and [private]. Present leak is with the name of isavelife. But both have the same followers. So it could be a renamed user? But we are not sure
