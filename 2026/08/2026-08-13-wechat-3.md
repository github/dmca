...
• https://github.com/WechatRagAgent/chatlog-new   
   
The Unlawful Repository describes itself as offering a tool to “retrieve [WeChat] chat data from [a] local database file,” including by “obtain[ing] the key and decrypt[ing] the data” (as translated).   
