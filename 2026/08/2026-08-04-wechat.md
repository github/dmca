...
The Unlawful Repository describes itself as offering a tool to perform “[l]ocal decryption” of “WeChat data,” including reading of the “WeChat 4.x database [to] output[] data such as messages, contacts, group chats, [and] media” (as translated).   
