...
• https://github.com/junuo-S/WeChatMsgDump   
   
The Unlawful Repository describes itself as offering a “tool for exporting and viewing WeChat messages,” which, inter alia, “reads key information from the logged-in WeChat process [and] decrypts the database.”   
...
In addition to the above, the Unlawful Repository relies upon and induces violation of the WeChat/Weixin Terms of Service, constituting intentional interference with enforceable contracts between Tencent and users of WeChat/Weixin.2   
