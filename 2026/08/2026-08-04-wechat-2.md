...
• https://github.com/cliffyan28/wechat-digest   
   
The Unlawful Repository describes itself as offering a tool for “extract[ing] chat logs from WeChat's local encrypted database” (as translated).   
